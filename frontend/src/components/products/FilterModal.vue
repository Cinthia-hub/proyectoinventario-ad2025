  ...
  <div class="fm-overlay" @click.self="onClose">
    <div class="fm-card" role="dialog" aria-modal="true" aria-labelledby="fm-title">
      <header class="fm-header">
        <h3 id="fm-title">Filter products</h3>
      ...
      <div class="fm-body">
        ...
        <p class="fm-hint">Tip: use partial text for fields like product name or category.</p>
      </div>
...
export default {
  ...
  methods: {
    ...
    placeholderFor(field) {
      const map = {
        nombre: "Enter product name",
        price: "Enter price (number)",
        quantity: "Enter quantity (number)",
        threshold_value: "Enter threshold (number)",
