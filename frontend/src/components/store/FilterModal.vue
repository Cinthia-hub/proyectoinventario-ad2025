  ...
  <div class="fm-overlay" @click.self="onClose">
    <div class="fm-card" role="dialog" aria-modal="true" aria-labelledby="fm-title">
      <header class="fm-header">
        <h3 id="fm-title">Filter stores</h3>
      ...
      <div class="fm-body">
        ...
        <p class="fm-hint">Tip: use partial text for names or address.</p>
      </div>
...
<style scoped>
/* mirrored style of other FilterModal components */
